    ...
    return (
        <div className="max-w-7xl mx-auto pt-7">
            ...
            <div className="flex gap-x-8 pt-10">
                ...
                <VisionCard title="Unbeatable value" desc="Get the best deal with Hêlane's extensive listings and competitive pricing and commissions." />
                <VisionCard title="Simple and convenient" desc="Find and purchase your dream home with ease on Hêlane." />
                <VisionCard title="Verified Agents" desc="Work with top-rated, verified agents who are dedicated to your success." />
            </div>
        </div>
    )
