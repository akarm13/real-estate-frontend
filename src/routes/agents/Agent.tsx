...
export const Agent = () => {
  ...
  return (
    ...
    {personDetail.map((person) =>{
      ...
      return <div key={id} className=" bg-white border-2 border  px-4 py-4 rounded-2xl ">

        <img src={img} alt='name' className='rounded-2xl w-[300px] h-[190px]'></img>
        ...
        <span className='flex gap-2 items-center mt-2'><LocationIcon/> {location}</span>
