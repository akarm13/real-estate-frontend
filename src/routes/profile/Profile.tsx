...
export const Profile = () => {
  const getActiveClassName = ({ isActive }: any) =>
    isActive
      ? "text-primary-500 border-primary-500 flex items-center gap-x-4 pb-2 border-b-2"
      : "text-gray-600 hover:text-primary-500 flex items-center gap-x-4 border-b-2 border-transparent pb-2";
