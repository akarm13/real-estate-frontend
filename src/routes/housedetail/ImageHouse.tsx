  ...
  return (
    <div className='mt-7 w-full flex  '>
     ...
     <p className='absolute top-2 left-4 bg-black text-white font-medium  px-12 py-2 rounded-lg'>For sale</p>
        ...
        <div className='relative'>
     <img src={Image1} alt='house' className='w-[400px] mx-12 h-[193px] rounded-2xl object-cover ' />
     
     <img src={Image1} alt='house'className='w-[400px] h-[193px] border-2 border-primary-500 mx-12 mt-4 rounded-2xl object-cover' />
     ...
     <button className='absolute bottom-2 right-14 border-primary-500  font-semibold text-sm bg-white flex items-center px-6 py-2 rounded-lg  '>
        ...
        <Picture/> <span className='ml-2'>View all 21 photos </span> </button>
