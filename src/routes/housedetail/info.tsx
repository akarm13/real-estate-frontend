...
const Info = () => {
 ...
 <span className='mx-4' >Active</span>
    ...
    <p className='text-secondaryText'>A beautiful 2-bedroom, 2-bathroom house, with a total area of 200 square meters, 
        is now available for sale in Aqary Street, Sulaymaniyah. This active listing features a spacious living area, 
        modern kitchen, and comfortable bedrooms. The house is well-maintained and ready for its new owners. 
        Its prime location in Aqary Street makes it a perfect choice for those looking for 
        easy access to local amenities and a convenient lifestyle. this is a great opportunity to own a 
        wonderful home in a sought-after location.</p>
    ...
    <div className='flex flex-col w-[400px] bg-white border border-[1px] my-12 ml-14 px-6 py-6 rounded-lg gap-6'>

        <h5 className='font-semibold text-lg'>Sale Price</h5>

        <h3 className='text-primary-500 text-2xl font-bold '>${houses?.price}</h3>
